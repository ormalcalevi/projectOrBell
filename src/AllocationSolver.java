...
public class AllocationSolver {
    ...
    public Map<Person, Shelter> solve (List<Shelter> sheltersList, GridMap map, int maxSteps ,List<Person> initialPeopleList ,Map<Person , List<Shelter>>optionalShelters) {
    ...
    public Map<Person, Shelter> getBestAssignmentSoFar() {
        return bestAssignmentSoFar;
    }
    ...
    public Map<Person, List<Shelter>> getOptionalSheltersForEachPerson() {
        return optionalSheltersForEachPerson;
    }
    ...
    private boolean shouldPrune(List<Person> unassignedPeople, Map<Person, Shelter> currentAssignment) {
        ...
        return false; // החזירי true אם צריך לגזום, אחרת false
    }
    ...
    private int calculatePotentialMax(List<Person> unassignedPeople, List<Shelter> allShelters, Map<Person, Shelter> currentAssignment) {
        ...
        //stage 2: total remaining capacity in the path
        ...
        for (Shelter shelter : allShelters) {
            ...
            //stage 3: potential additional saves
